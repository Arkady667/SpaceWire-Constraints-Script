...
# example> python spw_timing_script.py C:\Users\aczuba\PycharmProjects\SpaceWire-Constraints iSpw0Stb iSpw0Dat *r.do* *nr.d* 0 0.5 0.5
"""

argv1: Path to TCL script (~/report_spw_timing.tcl)
