...
patternBackgroundGood.pattern = patternBackgroundGood.pattern_back_colour = 0x03  # green
...
## Helpful during tests without argv and commands
...
def excel():
    """Control function, which execute each spreadsheet generation functions and saves excel ss
    ...
    print "Excel spreadsheet successfully created"
    try:
        wb.save('SpW Timing Verification.xls')
    except Exception as error:
        print("WARNING: Close excel spreadsheet 'SpW Timing Verification.xls' before running the script")
        print(error)
...
def excel_hold():
    ...
    hold.write_merge(3, 3, 1, 8, "BIT_PERIOD + D_SKEW + Shortest[Data to FF:D(Rise/Fall)] - Longest[Strobe to FF:CLK(Rise/Fall)] - Hold FF ", style=styleFormulaRight)
    hold.write(4, 1, "If Data Skew", style=styleText)
    hold.write_merge(5, 5, 1, 8, "BIT_PERIOD - S_SKEW + Shortest[Data to FF:D(Rise/Fall)] - Longest[Strobe to FD:CLK(Rise/Fall)] - Hold FF ", style=styleFormulaRight)
    ...
    # Data Skew
    hold.write_merge(9, 9, 1, 9, "BIT_PERIOD + D_SKEW + Shortest[Data to FF:D(Rise)] - Longest[Strobe to FF:CLK(Rise)] - Hold FF ",  style=styleLowHeader)
    ...
    hold.write_merge(11, 11, 1, 9, "BIT_PERIOD + D_SKEW + Shortest[Data to FF:D(Rise)] - Longest[Strobe to FF:CLK(Fall)] - Hold FF ", style=styleLowHeader)
    ...
    hold.write_merge(13, 13, 1, 9, "BIT_PERIOD + D_SKEW + Shortest[Data to FF:D(Fall)] - Longest[Strobe to FF:CLK(Rise)] - Hold FF ",  style=styleLowHeader)
    ...
    hold.write_merge(15, 15, 1, 9, "BIT_PERIOD + D_SKEW + Shortest[Data to FF:D(Fall)] - Longest[Strobe to FF:CLK(Fall)] - Hold FF ",  style=styleLowHeader)
    ...
    # Strobe Skew
    hold.write_merge(19, 19, 1, 9, "BIT_PERIOD - S_SKEW + Shortest[Data to FF:D(Rise)] - Longest[Strobe to FF:CLK(Rise)] - Hold FF ",  style=styleLowHeader)
    ...
    hold.write_merge(21, 21, 1, 9, "BIT_PERIOD - S_SKEW + Shortest[Data to FF:D(Rise)] - Longest[Strobe to FF:CLK(Fall)] - Hold FF ", style=styleLowHeader)
    ...
    hold.write_merge(23, 23, 1, 9, "BIT_PERIOD - S_SKEW + Shortest[Data to FF:D(Fall)] - Longest[Strobe to FF:CLK(Rise)] - Hold FF ",  style=styleLowHeader)
    ...
    hold.write_merge(25, 25, 1, 9, "BIT_PERIOD - S_SKEW + Shortest[Data to FF:D(Fall)] - Longest[Strobe to FF:CLK(Fall)] - Hold FF ",  style=styleLowHeader)
...
def excel_pulse():
    ...
    pulse.write_merge(3, 3, 1, 8, "BIT_PERIOD - D_SKEW - Longest[Data to FF:CLK(Rise/Fall)] + Shortest[Strobe to FF:CLK(Rise/Fall)] - Setup FF - Hold FF ", style=styleFormulaRight)
    pulse.write(4, 1, "If Data Skew", style=styleText)
    pulse.write_merge(5, 5, 1, 8, "BIT_PERIOD - S_SKEW - Longest[Strobe to FF:CLK(Rise/Fall)] + Shortest[Data to FF:CLK(Rise/Fall)] - Setup FF - Hold FF ", style=styleFormulaRight)
    ...
    # Data Skew
    pulse.write_merge(9, 9, 1, 9, "BIT_PERIOD - D_SKEW - Longest[Data to FF:CLK(Rise)] + Shortest[Strobe to FF:CLK(Rise)] - Setup FF - Hold FF ",  style=styleLowHeader)
    ...
    pulse.write(10, 12, "{0}".format(pulse_check(rise, rise, data)), style=styleResult)

    pulse.write_merge(11, 11, 1, 9, "BIT_PERIOD - D_SKEW - Longest[Data to FF:CLK(Rise)] + Shortest[Strobe to FF:CLK(Fall)] - Setup FF - Hold FF ", style=styleLowHeader)
    ...
    pulse.write(12, 12, "{0}".format(pulse_check(rise, fall, data)), style=styleResult)

    pulse.write_merge(13, 13, 1, 9, "BIT_PERIOD - D_SKEW - Longest[Data to FF:CLK(Fall)] + Shortest[Strobe to FF:CLK(Rise)] - Setup FF - Hold FF ",  style=styleLowHeader)
    ...
    pulse.write(14, 12, "{0}".format(pulse_check(fall, rise, data)), style=styleResult)

    pulse.write_merge(15, 15, 1, 9, "BIT_PERIOD - D_SKEW - Longest[Data to FF:CLK(Fall)] + Shortest[Strobe to FF:CLK(Fall)] - Setup FF - Hold FF ",  style=styleLowHeader)
    ...
    pulse.write(16, 12, "{0}".format(pulse_check(fall, fall, data)), style=styleResult)

    # Strobe Skew
    pulse.write_merge(19, 19, 1, 9, "BIT_PERIOD - S_SKEW - Longest[Strobe to FF:CLK(Rise)] + Shortest[Data to FF:CLK(Rise)] - Setup FF - Hold FF ",  style=styleLowHeader)
    ...
    pulse.write(20, 12, "{0}".format(pulse_check(rise, rise, strobe)), style=styleResult)

    pulse.write_merge(21, 21, 1, 9, "BIT_PERIOD - S_SKEW - Longest[Strobe to FF:CLK(Rise)] + Shortest[Data to FF:CLK(Fall)] - Setup FF - Hold FF ", style=styleLowHeader)
    ...
    pulse.write(22, 12, "{0}".format(pulse_check(rise, fall, strobe)), style=styleResult)

    pulse.write_merge(23, 23, 1, 9, "BIT_PERIOD - S_SKEW - Longest[Strobe to FF:CLK(Fall)] + Shortest[Data to FF:CLK(Rise)] - Setup FF - Hold FF ",  style=styleLowHeader)
    ...
    pulse.write(24, 12, "{0}".format(pulse_check(fall, rise, strobe)), style=styleResult)

    pulse.write_merge(25, 25, 1, 9, "BIT_PERIOD - S_SKEW - Longest[Strobe to FF:CLK(Fall)] + Shortest[Data to FF:CLK(Fall)] - Setup FF - Hold FF ",  style=styleLowHeader)
    ...
    pulse.write(26, 12, "{0}".format(pulse_check(fall, fall, strobe)), style=styleResult)
